"""
Pipeline module (not tests): Translation → Readability → Fidelity.
"""
...
def phase_1_translation_quality(english_text: str, rough_dutch: str):
    ...
    task = Task(
        description=(
            ...
            "OUTPUTREGELS (strict):\n"
            "- Output is 100% Nederlands.\n"
            "- Geen uitleg, geen meta-commentaar, geen labels, geen markdown.\n"
            "- Geen Engels; verwijder/vertal alles naar Nederlands.\n"
            "- Exact 1 blok tekst (geen kopjes).\n\n"
            "GEEF ALLEEN de verbeterde Nederlandse tekst terug.\n\n"
            "Engelse brontekst:\n"
            f"{english_text}\n\n"
...
def phase_2_readability(nl_text: str):
    ...
    task = Task(
        description=(
            ...
            "- Geen Engels; verwijder/vertal alles naar Nederlands.\n"
            "- Exact 1 blok tekst (geen kopjes).\n\n"
            "GEEF ALLEEN de definitieve Nederlandse tekst terug.\n\n"
            "Tekst:\n"
            f"{nl_text}\n"
        ),
...
def phase_3_fidelity(english_text: str, nl_text: str):
    ...
    task = Task(
        description=(
            ...
            "- Het woord 'Opmerkingen:' mag alleen in het opmerkingenblok voorkomen.\n"
